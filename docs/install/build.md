...
[`iso/`](https://github.com/lukeharg/junkmesh/tree/main/iso) and uses
...
### [`mkimg.junkmesh.sh`](https://github.com/lukeharg/junkmesh/blob/main/iso/mkimg.junkmesh.sh) — the profile
...
### [`genapkovl-junkmesh.sh`](https://github.com/lukeharg/junkmesh/blob/main/iso/genapkovl-junkmesh.sh) — the overlay
...
Alpine? It builds the [`Dockerfile`](https://github.com/lukeharg/junkmesh/blob/main/iso/Dockerfile)
...
The [`iso.yml` workflow](https://github.com/lukeharg/junkmesh/blob/main/.github/workflows/iso.yml)
